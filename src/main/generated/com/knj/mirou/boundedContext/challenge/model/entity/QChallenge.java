...
public class QChallenge extends EntityPathBase<Challenge> {
    ...
    public final NumberPath<Integer> joinCost = createNumber("joinCost", Integer.class);

    public final DatePath<java.time.LocalDate> joinDeadline = createDate("joinDeadline", java.time.LocalDate.class);

    public final NumberPath<Integer> level = createNumber("level", Integer.class);

    public final EnumPath<com.knj.mirou.boundedContext.challenge.model.enums.AuthenticationMethod> method = createEnum("method", com.knj.mirou.boundedContext.challenge.model.enums.AuthenticationMethod.class);
    ...
    public final EnumPath<com.knj.mirou.boundedContext.challenge.model.enums.ChallengeTag> tag = createEnum("tag", com.knj.mirou.boundedContext.challenge.model.enums.ChallengeTag.class);
