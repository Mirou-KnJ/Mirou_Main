...
public class QMember extends EntityPathBase<Member> {
    ...
    public QMember(Class<? extends Member> type, PathMetadata metadata, PathInits inits) {
        ...
        this.coin = inits.isInitialized("coin") ? new com.knj.mirou.boundedContext.coin.entity.QCoin(forProperty("coin"), inits.get("coin")) : null;
        this.point = inits.isInitialized("point") ? new com.knj.mirou.boundedContext.point.entity.QPoint(forProperty("point"), inits.get("point")) : null;
    }
